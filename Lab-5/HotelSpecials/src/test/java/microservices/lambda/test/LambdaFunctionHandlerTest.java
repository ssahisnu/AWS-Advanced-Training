...
import microservices.lambda.HotelSpecialsHandler;
...
public class LambdaFunctionHandlerTest {
    ...
    public void testLambdaFunctionHandler() {
		...
		{    	
	        HotelSpecialsHandler handler = new HotelSpecialsHandler();
	        
	        // Can't test on CodeBuild without access to DB/VPC
	        LambdaResult<List<HotelSpecial>> result = handler.handleRequest(input, ctx);
